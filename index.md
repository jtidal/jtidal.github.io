		...
		<div class="card card-info">
			<div class="card-header"><h2 class="embolden"><i class="bi-alarm icon-space" ></i><a href="https://libcal.citytech.cuny.edu">Hours</a></h2></div>
				...
				<style>
					...
					.s-lc-w-btn { line-height: 1.5; border-radius: 3px; display: inline-block; padding: 6px 0px 10px; 0px; margin-bottom: 0; font-size: 12px; font-weight: 400; text-align: center; white-space: nowrap; vertical-align: middle; touch-action: manipulation; cursor: pointer; user-select: none; border: 1px solid #ccc; color: #3333; background-color: #fff; display: none; }
