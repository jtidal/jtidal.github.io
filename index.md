...
<!--SEARCH THE COLLECTION-->
	<div class="col-md-9 col-sm-12">
		<div class="card" >
			<div class="card-header" style="background-color:#007FA3; color:white;"><h1 class="embolden"><i class="bi-search icon-space"></i>Search the collection</h1></div>
			<div class="card-body">
...
<div class="row">
	<div class="col-md-12 col-sm-12" style="padding-bottom:10px;">
		<div class="card">
			<div class="card-header" style="background-color:#FF9B29; color:#000000;">
...
<!--WORKSHOPS-->
	...
	<div class="card card-warning">
	  <div class="card-header" style="background-color: #FF9B29; color:000000;"><h2 class="embolden"><i class="bi-people-fill icon-space"></i>Workshops</h2></div>
	  <div class="card-body">
...
<!--EXPLORE-->
	<div class="card card-primary">
	  <div class="card-header" style="background-color:#FF9B29; color:000000;"><h2 class="embolden"><i class="bi-globe icon-space"></i>Explore</h2></div>
	  <div class="card-body">
